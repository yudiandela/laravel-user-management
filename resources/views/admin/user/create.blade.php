                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="file" name="photo" class="file-upload-default" value="{{ old('photo') }}">
                                <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info{{ $errors->has('photo') ? ' is-invalid' : '' }}" value="{{ old('photo') }}" disabled="" placeholder="Upload Image">
